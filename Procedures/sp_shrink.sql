-- PROCEDURE UTILIZADA PARA TRAZER OS DISCOS COM DATAFILES EM CRESCIMENTO, TAMANHO TOTAL, TAMANHO LIVRE, ETC..
-- O PRIMEIRO RESULT TRÁS AS INFORMAÇÕES PASSADAS ACIMA, PORÉM O SEGUNDO RESULT NOS MONTA O SCRIPT DE SHRINK A SER EXECUTADO;
-- CASO DESEJE FAZER UM FILTRO PARA DISCO ESPECÍFICO OU UMA DATABASE, PODE SER EXECUTADO A PARTIR DO PRIMEIRO "DECLARE" E ASSIM SEGUIR COM AS ALTERAÇÕES DESEJADAS.
