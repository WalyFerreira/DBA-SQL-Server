-- PROCEDURE CRIADA POR ADAM MACHANIC, COM O OBJETIVO DE DETALHAR E APRESENTAR UM CONJUNTO DE INFORMAÇÕES MAIS RICO E DETALHADO DO QUE A SP_WHO2 E SP_WHO;
-- PARA MAIS ENTENDIMENTO DA FUNCIONALIDADE E DE PARÂMETROS DA PROCEDURE, SEGUE UM ÓTIMO ARTIGO: https://dirceuresende.com/blog/sql-server-utilizando-a-sp-whoisactive-para-identificar-locks-blocks-queries-lentas-queries-em-execucao-e-muito-mais/

USE [master]
GO
/****** Object:  StoredProcedure [dbo].[sp_whoisactive]    Script Date: 21/03/2015 14:23:40 ******/
SET ANSI_NULLS ON
GO
