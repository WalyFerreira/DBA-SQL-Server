-- Proc utilizada para validar conexões dentro do banco de dados, trazendo a relação de utilização de CPU, 
-- memória, quantidade de bloqueios, sessões ativas, sql text, show plan, etc..
